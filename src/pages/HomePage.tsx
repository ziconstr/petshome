...
style={{ fontFamily: "var(--font-display)" }}
      ...
      <section id="new-pets" className="max-w-6xl mx-auto px-4 py-14">
        <div className="flex items-center justify-between mb-6">
          <div>
            <p className="text-sky-500 font-bold text-sm uppercase tracking-widest mb-1">Just arrived</p>
            <h2 style={{ fontFamily: "var(--font-display)" }} className="text-3xl sm:text-4xl font-bold text-slate-800">
              🐣 New Pets
            </h2>
          </div>
          <a href="#all-pets" className="text-sky-600 font-bold hover:underline text-sm">
            See all →
          </a>
        </div>
      ...
      <section id="all-pets" className="max-w-6xl mx-auto px-4 py-14">
        <div className="mb-6">
          <p className="text-sky-500 font-bold text-sm uppercase tracking-widest mb-1">Ready for adoption</p>
          <h2 style={{ fontFamily: "var(--font-display)" }} className="text-3xl sm:text-4xl font-bold text-slate-800">
            🐾 All Pets
          </h2>
        </div>
        ...
        {!loading && !error && filtered.length === 0 && (
          <div className="text-center py-20">
            ...
            <p className="text-slate-500 text-lg font-semibold">No pets match your search.</p>
            <button
        ...
        {!loading && !error && filtered.length > 0 && (
          <>
            <p className="text-slate-400 text-sm mb-4 font-semibold">{filtered.length} pets available</p>
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
