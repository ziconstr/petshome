...
import { login, createApiKey } from "../api/pets";
    ...
    <main className="min-h-screen flex items-center justify-center px-4 py-10 bg-gradient-to-br from-sky-50 to-white">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-500 mt-1">Sign in to manage pet listings</p>
        </div>
        <div className="bg-white rounded-3xl p-8 shadow-sm border border-sky-100">
          ...
          <p className="text-center text-slate-500 text-sm mt-4">
            ...
            <Link to="/account/register" className="text-sky-600 font-semibold hover:underline">Register</Link>
          </p>
        </div>
      </div>
    </main>
